                  ...
                  <div className="row">
                     <div className="col-md-12 text-left pl-5 pr-5">
                        <div className="Content_Bar">
                           ...
                           <marquee behavior="scroll" direction="left" id="marquee"><strong>Hello Student, we are revamping our site & will be live till 19th Dec'21. Till the time, please do not purchase any subscription</strong>
                           </marquee>
