                ...
                <div className="tab-content">
                    <div className="tab-pane stretchRight active" id="dashboard">
                        <div className="menu">
                            ...
                            <li className="active open"><Link to="/tutor/dashboard"><><i className="zmdi zmdi-home"></i><span>Dashborad</span></></Link></li>
                            <li className="active open"><Link to="/tutor/profile"><><i className="zmdi zmdi-account"></i><span>Profile</span></></Link></li>
                            <li><Link to="/tutor/profile"><><i className="zmdi zmdi-money"></i><span>My Earnings</span></></Link></li>
                            <li><Link to="/tutor/start-answering"><><i className="flaticon-answer"></i><span>Start Answering</span></></Link></li>
                            <li><Link to="/tutor/profile"><><i className="flaticon-work"></i><span>My work Stats</span></></Link></li>
                                <li><Link to="/tutor/profile"><><i className="flaticon-solution"></i><span>Sample Solutions</span></></Link></li>
                                <li><Link to="/tutor/profile"><><i className="flaticon-problem"></i><span>How it Works</span></></Link></li>
                                <li><Link to="/tutor/profile"><><i className="flaticon-guidelines"></i><span>Project Guidelines</span></></Link></li>
                                <li><Link to="/tutor/profile"><><i className="zmdi zmdi-notifications"></i><span>Notifications</span></></Link></li>
                                <li><Link to="/tutor/profile"><><i className="flaticon-faq"></i><span>FAQ</span></></Link></li>
                            </ul>
                        </div>
                    </div>
                    <div className="tab-pane stretchLeft" id="user">
