...
console.log('date------>', data);
  ...
  return (
    <nav
      className={`navbar navbar-expand-lg navbar-light sticky-top ${homePClass}`}
    >
      <div className="container">
        <Link to="/" className="navbar-brand">
          <img src={`/images/${homePImage}`} className="img-fluid" alt="logo" />
        </Link>
        <button
          className={
            "navbar-toggler " + (mobileMenuClass == "show" ? "" : "collapsed")
          }
          type="button"
        ...
        <div
          className={`collapse navbar-collapse ${mobileMenuClass}`}
          ...
          {isMobile ? (
            <ul className="navbar-nav solu_nav ml-auto">
              ...
              >
                ...
                {showMenu && (
                  <ul
                    className={`dropdown-menu dropdownmenu_main ${classname}`}
                    aria-labelledby="navbarDropdown"
                    onMouseLeave={() => hideMenu()}
                  >
                    <HashLink
                      to="/textbook-solutions-manuals#solution-manuals"
                    ...
                    {data &&
                      data.map((item, key) => {
                        return (
                          <li className="dropright" key={key}>
                            <a
                              className={
                                "dropdown-item " +
                                (list === key ? "active" : "")
                              ...
                              href="#"
                              onClick={(e) => {
                                openSubMenuMobile(e, key);
                              }}
                            >
                              <h6>
                                <img
                                  src={`/images/nav-icons/${MakeSlug(
                                    item.subject
                                  )}.png`}
                                  className="img-fluid"
                                  alt=""
                            ...
                            >
                              ...
                              {item.sub_subject.map((it, key) => {
                                return (
                                  <HashLink
                                    to={`/textbook-solutions-manuals/${
                                      MakeSlug(item.subject) +
                                      "/" +
                                      MakeSlug(it.sub_subject)
                                    }`}
                                    key={key}
                                    className="dropdown-item"
                                  >
              ...
              <li
                className="nav-item dropdown dropdown_reltv"
                onClick={() => {
                  openMenuAMobile();
                }}
              >
                ...
                {showAMenu && (
                  <div
                    className={`dropdown-menu sm-menu ${classname}`}
                    aria-labelledby="navbarDropdown"
                  >
                    <Link
                      to="/writing-help/online-assignment-help"
                      className="dropdown-item"
                    >
                      <img
                        src="/images/nav-icons/online-assignment-help.png"
                        className="img-fluid"
                        alt=""
                      />{" "}
                      Assignment Help{" "}
              ...
              {session !== undefined && !session ? (
                <li className="nav-item login_signup_top">
