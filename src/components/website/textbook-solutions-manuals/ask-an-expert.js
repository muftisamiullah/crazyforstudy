            ...
            <div className="container">
                ...
                <div className="col-md-6">
                    <div className="Text_title2 text_tb_center pb-3">
                        ...
                        <p>Struggling with textbook solutions? Getting Tough or Difficult textbook question? We have all the textbook that you need! Get step-by-step textbook solutions by our experts.</p>
                        <div className="btn1">
