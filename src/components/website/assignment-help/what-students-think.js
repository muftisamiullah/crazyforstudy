        ...
        <section className="section bg_colr2 mt-5 pt-4 pb-4">
            <div className="container">
                ...
                <OwlCarousel items={5} className="testimonial owl-theme" loop autoplay={false} nav margin={10} dots={false} center={true} >
                    <div className="item"><span className="img_testimonial"><img src="/images/testimonial-img/mary-thunders.png" className="" alt=""/></span>
                    ...
                    <div className="item"><span className="img_testimonial"><img src="/images/testimonial-img/robert-taylor.png" className="" alt=""/></span>
                    <div className="text-center testimonial_text">
                    <h3>Robert Taylor</h3>
                    ...
                    <div className="item"><span className="img_testimonial"><img src="/images/testimonial-img/willie-brown.png" className="" alt=""/></span>
                    <div className="text-center testimonial_text">
                    <h3>Willie Brown</h3>
                    ...
                    <div className="item"><span className="img_testimonial"><img src="/images/testimonial-img/maraya-smith.png" className="" alt=""/></span>
                    <div className="text-center testimonial_text">
                    <h3>Maraya Smith</h3>
                    ...
                    <div className="item"><span className="img_testimonial"><img src="/images/testimonial-img/harrish-williamson.png" className="" alt=""/></span>
                    <div className="text-center testimonial_text">
                    ...
                    <div className="item"><span className="img_testimonial"><img src="/images/testimonial-img/david-jones.png" className="" alt=""/></span>
                    <div className="text-center testimonial_text">
                    <h3>David Jones</h3>
