					...
					<div className="col-md-12">
						<div className="card student-list">
							...
							<div className="col-md-12 mt-4 your_subscription hjh6f4 ask_qus">
								<h2><img src="/images/askqus_icon.png" className="img-fluid"/> Ask a Question </h2>
								<p className="mt-2">50 questions left for you to ask before the end of the cycle. Ask away! </p>
								<p>Post your homework question and get notified when it has been answered. We don’t take more than a few hours.</p>
							</div> 
																	...
																	<div className="images_pikar1">
																			...
																			<output id="Filelist">
																				<ul className="thumb-Images" id="imgList">
																					{formData.image1 && <li>
																						<div className="img-wrap"> <span className="close" onClick={removeImage1}>×</span>
																							<img id="img1" className="thumb thumb2fd4" src={image && image.image1 ? image.image1 : '/images/upload-icon1.png'} title={image && image.image1} alt="your image" ref={image1}/>
																						</div>
																						<div className="FileNameCaptionStyle"></div>
																					</li>}
																					{formData.image2 && <li>
																						<div className="img-wrap"> <span className="close" onClick={removeImage2}>×</span>
																							<img id="img1" className="thumb thumb2fd4" src={image && image.image2 ? image.image2 : '/images/upload-icon1.png'} title={image && image.image2} alt="your image" ref={image2}/>
																						</div>
																						<div className="FileNameCaptionStyle"></div>
																					</li>}
																				</ul>
										...
										<div className="row"> 
											<div className="col-md-12">
												<div className="Text_title text_tb_center3 pb-3"> 
													<h2>How It Work</h2> 
													<ul className="include_list">
														<li><img src="/images/right-icon1.png" className="img-fluid" alt=""/> Post one question at a time.</li>
														<li><img src="/images/right-icon1.png" className="img-fluid" alt=""/> Keep questions specific and do not forget to add the necessary details.</li>
														<li><img src="/images/right-icon1.png" className="img-fluid" alt=""/> Our experts will work on your question.  </li>
														<li><img src="/images/right-icon1.png" className="img-fluid" alt=""/> You get notified once your answer is ready.</li>
														<li><img src="/images/right-icon1.png" className="img-fluid" alt=""/> Access the answer from 'My Question Status&rsquo;. </li>
													</ul>
													<div className="believe_pera">
														<p>We believe in working with honesty and integrity, just like you…” Learn more about our <a href="#" data-toggle="modal" data-target="#modal_CFSA" onClick={openDialog}>honor code</a></p>
													</div>
